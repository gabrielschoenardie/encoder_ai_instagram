...
| LUT padrão | `HollywoodCinema_Ultimate_v6.8` | `FilmLook_Portra400_SkinPriority_D65` |
...
### LUT: HollywoodCinema_Ultimate_v6.8_3.1-96IRE_Instagram8bit_NeutralShadows.cube
- **3.1 IRE**: sombras neutras — não há crushing de negros, o que preserva detalhe
...
- Confirmar que a LUT `HollywoodCinema_Ultimate_v6.8` está no path correto
